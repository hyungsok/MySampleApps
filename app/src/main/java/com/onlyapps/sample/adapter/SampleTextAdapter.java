...
public class SampleTextAdapter extends ArrayAdapter<String> {
    ...
    public SampleTextAdapter(final Context context, final int textViewResourceId) {
        ...
        mBackgroundColors.add(R.color.blue_grey);
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.list_item_text, parent, false);
            vh = new ViewHolder();
